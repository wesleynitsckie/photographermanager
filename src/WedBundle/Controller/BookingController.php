...
use WedBundle\Entity\Booking;
use WedBundle\Form\BookingType;
...
class BookingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WedBundle:Booking')->findAll();
     ...
     * @Method("POST")
     * @Template("WedBundle:Booking:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WedBundle:Booking')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WedBundle:Booking:edit.html.twig")
     */
