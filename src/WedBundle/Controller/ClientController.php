...
use WedBundle\Entity\Client;
use WedBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WedBundle:Client')->findAll();
     ...
     * @Method("POST")
     * @Template("WedBundle:Client:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WedBundle:Client')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WedBundle:Client:edit.html.twig")
     */
