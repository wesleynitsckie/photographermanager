...
use WedBundle\Entity\Package;
use WedBundle\Form\PackageType;
...
class PackageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WedBundle:Package')->findAll();
     ...
     * @Method("POST")
     * @Template("WedBundle:Package:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WedBundle:Package')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WedBundle:Package:edit.html.twig")
     */
